...
namespace Patient_Cards_Model.DTO.GL
{
    public class GLCurrentCorrectionDTO
    {
        ...
        public GLCurrentCorrectionDTO() { }

        public GLCurrentCorrectionDTO(int? id, decimal? sphere, decimal? cylinder, int? axis, decimal? addition, decimal? prism, int? baseId, string baseName, int eyeId, string eyeName, int? cardId)
        {
            Id = id;
            Sphere = sphere;
            Cylinder = cylinder;
