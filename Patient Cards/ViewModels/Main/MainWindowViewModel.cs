...
namespace Patient_Cards.ViewModels.Main
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private PatientCardCollector patientCardCollector;
            ...
            : base(eventAggregator, unityContainer, dictionariesService)
        {
            ...
            this.patientCardCollector = new PatientCardCollector();
            this.patientCardCollector.FilledEvent += SaveCard;
        }
        ...
        public DelegateCommand Loaded
        {
            ...
            {
                events.Add(
                    eventAggregator.GetEvent<PersonDataResponseEvent>(),
                    eventAggregator.GetEvent<PersonDataResponseEvent>().Subscribe(vm => patientCardCollector.AddViewModel(vm.GetType(), vm)));
        ...
        {
            PersonalDataViewModel vm = patientCardCollector.GetViewModel(typeof(PersonalDataViewModel)) as PersonalDataViewModel;

            patientCardCollector.Clear();
