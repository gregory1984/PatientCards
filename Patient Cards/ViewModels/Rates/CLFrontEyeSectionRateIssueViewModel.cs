...
{
    public class CLFrontEyeSectionRateIssueViewModel : BindableBase
    {
        ...
        public CLFrontEyeSectionRateIssueViewModel(CLFrontEyeSectionRateDTO dto)
        {
            Id = dto.Id;
            CurrentVisitRate = dto.CurrentVisitRate;
            ControlVisitRate = dto.ControlVisitRate;
            CardId = dto.CardId;
            IssueId = dto.CLFronEyeSectionIssueId;
            IssueName = dto.CLFronEyeSectionIssueName;
        }
    }
}
